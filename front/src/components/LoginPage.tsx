...
import { login, type AuthState } from '../api/auth'
...
function LoginPage({ setAuth, showFlash }: Props) {
    ...
    <div className="min-h-[calc(100vh-4rem)] bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">毎日の食事で健康をサポート</p>
        </div>

        <div className="bg-white rounded-3xl shadow-xl px-8 py-8">
          <h2 className="text-lg font-bold text-gray-700 mb-6 text-center">ログイン</h2>
